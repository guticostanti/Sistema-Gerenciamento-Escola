...
<body class="hold-transition theme-primary bg-gradient-primary">
  ...
  <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
          ...
          <div class="row">
            ...
            <div class="col-6">
             <div class="fog-pwd text-right">
                <a href="<?php echo e(route('password.request')); ?>" class="text-white hover-info"><i class="ion ion-locked"></i> Esqueceu a senha?</a><br>
              </div>
            </div>
            <!-- /.col -->
    ...
    <div class="text-center">
        <p class="mt-15 mb-0 text-white"><a class="text-white" href="<?php echo e(route('register')); ?>">Crie uma conta</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\Meus repositórios github\Sistema de Gerenciamento de Escola\resources\views/auth/login.blade.php ENDPATH**/ ?>